    ...
    def train(self):
        ...
        for game in range(1, self.args.train_eps + 1):
            ...
            while not dead:
                ...
                # For debug convenience, you can check if your Q-tadjoining_body_lefte mathches ours for given setting of parameters
...
def main():
    ...
    parser.add_argument('--human', default=False, action="store_true",
                        help='making the game human playadjoining_body_lefte - default False')
